...
public class UiElementProxy extends BaseUiElementProxy implements UiElement{
	private UiElementType elementType = UiElementType.GENERIC;
	private ConcreteUiElement<?,?> concreteElement = null;

	public UiElementProxy(UI ui, UiAutomatorProxy automator, UiElementMetaData emd) {
		super(ui, automator, emd);
	}
	
	public UiElementProxy(UiAutomatorProxy automator, UiElementMetaData emd) {
		super(automator, emd);
	}
	...
	public UiElementProxy asDropDown() throws Exception {
		this.getAutomator().getConcreteAutomator().getPicker().convertToDropDown(this);
		return this;
	}

	private UiElementType getType() {
