...
public abstract class AbstractUiAutomator<D,E> implements ConcreteUiAutomator<D,E>{
	private TestContext testContext = null;
	private OSType os = null;
	UiDriverEngine uiAutomatorEngineName = null;
	private UiAutomationContext automatorContext = null;
	String appTitle = null;
	private ElementLoaderType loaderType = ElementLoaderType.AUTOMATOR;
	private UiElementPicker<D,E> picker = null;
	private int waitTime = 10;
	private UiAutomatorProxy proxy = null;
	private ImageComprator imageComprator = null;
	
	public AbstractUiAutomator(TestContext testContext) throws Exception {
	...
	public AbstractUiAutomator(TestContext testContext, UiDriverEngine name, UiAutomationContext automatorContext) throws Exception{
		this(testContext);
		this.setUiTestEngineName(name);
		this.setAutomatorContext(automatorContext);
	}
	
	public AbstractUiAutomator(TestContext testContext, UiDriverEngine name, UiAutomationContext automatorContext, ElementLoaderType loaderType) throws Exception{
		this(testContext, name, automatorContext);
		this.setElementLoaderType(loaderType);
	}
	
	@Override
	public void setProxy(UiAutomatorProxy proxy) {
		this.proxy = proxy;
	}

	@Override
	public UiAutomatorProxy getProxy() {
		return this.proxy;
	}
	...
	protected void setPicker(UiElementPicker<D,E> picker) {
		this.picker = picker;
	}
	
	public UiElementPicker<D,E> getPicker(){
		return this.picker;
	}
	...
	public UiAutomationContext getAutomatorContext() {
		return automatorContext;
	}

	public void setAutomatorContext(UiAutomationContext context) {
