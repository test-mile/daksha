 ...
 ******************************************************************************/
package daksha.core.meaningful.element.sikuli;
...
import daksha.core.meaningful.element.BaseConcreteGuiSingleElement;
...
public class SikuliElement extends BaseConcreteGuiSingleElement<Screen,Match>{
	...
	private String getImagePathForSecondElement(String name) throws Exception {
		GuiElementMetaData emd = this.getGui().getDefinition().getMetaData(name);
