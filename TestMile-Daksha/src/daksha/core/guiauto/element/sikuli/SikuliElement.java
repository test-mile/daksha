 ...
 ******************************************************************************/
package daksha.core.guiauto.element.sikuli;
...
import daksha.core.guiauto.element.BaseConcreteGuiSingleElement;
...
public class SikuliElement extends BaseConcreteGuiSingleElement<Screen,Match>{
	...
	private String getImagePathForSecondElement(String name) throws Exception {
		GuiElementMetaData emd = this.getGui().getDefinition().getMetaData(name, this.getAutomator().getAutomatorContext());
