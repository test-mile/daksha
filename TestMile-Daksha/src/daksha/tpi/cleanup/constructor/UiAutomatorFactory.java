...
import daksha.core.cleanup.automator.sikuli.SikuliScreenUiDriver;
import daksha.tpi.cleanup.constructor.appium.AppiumBuilder;
import daksha.tpi.cleanup.constructor.selenium.SeleniumBuilder;

public class UiAutomatorFactory {
	...
	public static UiAutomatorProxy getSikuli(TestContext testContext) throws Exception{
		return new UiAutomatorProxy(new SikuliScreenUiDriver(testContext));
	}
