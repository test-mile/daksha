...
package daksha.ex.guiauto.model3.pageFactory;
...
public class WebTestWithSeleniumAutomator extends TestNGBaseTest{
	private ThreadLocal<Page> threadWiseHomePage = new ThreadLocal<Page>();
	...
	public void createAutomator(ITestContext testContext) throws Exception {
		...
		Page home = PageFactory.getPage(builder.build(), "wordpress/HomePage.ini");
		threadWiseHomePage.set(home);
	}
	
	@Test
	public void test() throws Exception{
		Page page = this.threadWiseHomePage.get();
