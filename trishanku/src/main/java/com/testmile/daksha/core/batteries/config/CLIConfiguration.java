...
import com.testmile.daksha.core.enums.ConfigPropertyType;
...
public class CLIConfiguration {
	...
	Map<ConfigPropertyType, Map<DakshaOption,String>> cliDakshaOptionsMap = new HashMap<>();
	...
	public CLIConfiguration() throws Exception {
		...
		cliDakshaOptionsMap.put(ConfigPropertyType.DCENTRAL, new HashMap<DakshaOption,String>());
		cliDakshaOptionsMap.put(ConfigPropertyType.DTEST, new HashMap<DakshaOption,String>());
	...
	public Map<DakshaOption,String> getDakshaCentralOptions(){
		return this.cliDakshaOptionsMap.get(ConfigPropertyType.DCENTRAL);
	}
	
	public Map<DakshaOption,String> getDakshaTestOptions(){
