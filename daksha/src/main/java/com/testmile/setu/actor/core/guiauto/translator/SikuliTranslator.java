...
public class SikuliTranslator implements  GuiAutoTranslator {
	private DriverDispatcher automator = null;
	private String id = null;
//	private GuiElementHandler elementHandler = new GuiElementHandler();

	public SikuliTranslator(String setuId) throws Exception {
		id = setuId;
	}
